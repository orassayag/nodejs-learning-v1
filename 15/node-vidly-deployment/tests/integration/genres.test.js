...
describe('/api/genres', () => {
    ...
    describe('GET /:id', () => {
        ...
        it('should return 404 genre by given Id that does not exist in the database.', async () => {
            // Insert fake genre.
            const genre = await new Genre({
                name: 'genre1'
            }).save();
    ...
    describe('POST /', () => {
        ...
        it('should return 400 if client not provided a name parameter that is less than 5 characters length.', async () => {
        ...
        it('should return 400 if client not provided a name parameter that is more than 50 characters length.', async () => {
...
describe('/api/returns', () => {
    ...
    it('should return 500 if rental is already processed.', async () => {
        // Create the customer and the movie.
        await createCustomer();
        await createMovie();
